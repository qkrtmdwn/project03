...
?>
		<div id="header" class="cf">
			<div id="top" class="cf">
				<div id="mainLogo">
					<h1 class="fl"><a href="index.php" tabindex="0" class="showBalloon" title="보건복지부 메인페이지"><img src="include/images/h1_logo.jpg" width="260" height="70" alt="보건복지부"/><span>보건복지부</span></a></h1>
				</div> <!-- id="mainLogo -->
...
?>
				...
				<div class="counterLogout">
					<span id="counter"></span><span>후 자동 로그아웃</span><input type="button" value="연장" onclick="counterReset()"/>
				</div>
